        ...
        def customerTableCatalog =
            s"""{
                ...
                |"columns":{
                    ...
                    |"customer_addr_fk":                {"cf":"c", "col":"fa", "type":"int"},
                    |"customer_addr_geom":              {"cf":"c", "col":"fb", "type":"string"},
                    |"customer_city_fk":                {"cf":"c", "col":"ha", "type":"int"},
                    |"customer_city_geom":              {"cf":"c", "col":"hb", "type":"string"},
                    |"customer_nation_fk":              {"cf":"c", "col":"ia", "type":"int"},
                    |"customer_nation_geom":            {"cf":"c", "col":"ib", "type":"string"},
                    |"customer_region_fk":              {"cf":"c", "col":"ja", "type":"int"},
                    |"customer_region_geom":            {"cf":"c", "col":"jb", "type":"string"}
                    |
                |}
            |}""".stripMargin
        ...
        def supplierTableCatalog =
            s"""{
                ...
                |"columns":{
                    ...
                    |"supplier_addr_fk":                {"cf":"d", "col":"ga", "type":"int"},
                    |"supplier_addr_geom":              {"cf":"d", "col":"gb", "type":"string"},
                    |"supplier_city_pk":                {"cf":"d", "col":"ha", "type":"int"},
                    |"supplier_city_geom":              {"cf":"d", "col":"hb", "type":"string"},
                    |"supplier_nation_pk":              {"cf":"d", "col":"ia", "type":"int"},
                    |"supplier_nation_geom":            {"cf":"d", "col":"ib", "type":"string"},
                    |"supplier_region_pk":              {"cf":"d", "col":"ja", "type":"int"},
                    |"supplier_region_geom":            {"cf":"d", "col":"jb", "type":"string"}
                    |
                |}
            |}""".stripMargin
