...
object M1BG1 {
    ...
    def main(args: Array[String]) {
        ...
        def lineorderTableCatalog =
            s"""{
                ...
                |"columns":{
                    ...
                    |"customer_address_fk":             {"cf":"d", "col":"di", "type":"string"},
                    |"customer_city_fk":                {"cf":"d", "col":"dj", "type":"string"},
                    |"customer_nation_fk":              {"cf":"d", "col":"dk", "type":"string"},
                    |"customer_region_fk":              {"cf":"d", "col":"dl", "type":"string"},
                    ...
                    |"supplier_address_fk":             {"cf":"e", "col":"eh", "type":"string"},
                    |"supplier_city_fk":                {"cf":"e", "col":"ei", "type":"string"},
                    |"supplier_nation_fk":              {"cf":"e", "col":"ej", "type":"string"},
                    |"supplier_region_fk":              {"cf":"e", "col":"ek", "type":"string"},
                    ...
                    |"supplier_addr_pk":                {"cf":"h", "col":"ha", "type":"int"},
                    |"supplier_addr_geom":              {"cf":"h", "col":"hb", "type":"string"},
                    |"city_pk":                         {"cf":"i", "col":"ia", "type":"int"},
                    |"city_geom":                       {"cf":"i", "col":"ib", "type":"string"},
                    |"nation_pk":                       {"cf":"j", "col":"ja", "type":"int"},
                    |"nation_geom":                     {"cf":"j", "col":"jb", "type":"string"},
                    |"region_pk":                       {"cf":"k", "col":"ka", "type":"int"},
                    |"region_geom":                     {"cf":"k", "col":"kb", "type":"string"}
                    |
                |}
            |}""".stripMargin
        ...
        var Q4 = 
            ...
            | FROM
            |
            |   (SELECT * FROM t WHERE customer_addr_pk IS NOT NULL) f,
            |   (SELECT * FROM t WHERE line_order_order_number_pk IS NOT NULL) a
            |
            | WHERE
            |
