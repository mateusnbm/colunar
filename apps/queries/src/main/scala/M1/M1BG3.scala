            ...
            def lineorderTableCatalog =
                s"""{
                    ...
                    |"columns":{
                        ...
                        |"customer_city_fk":                {"cf":"g", "col":"gb", "type":"string"},
                        |"customer_addr_geom":              {"cf":"g", "col":"gc", "type":"string"},
                        |"supplier_addr_pk":                {"cf":"h", "col":"ha", "type":"int"},
                        |"supplier_city_fk":                {"cf":"h", "col":"hb", "type":"string"},
                        |"supplier_addr_geom":              {"cf":"h", "col":"hc", "type":"string"},
                        |"city_pk":                         {"cf":"i", "col":"ia", "type":"int"},
                        |"city_nation_fk":                  {"cf":"i", "col":"ib", "type":"string"},
                        |"city_geom":                       {"cf":"i", "col":"ic", "type":"string"},
                        |"nation_pk":                       {"cf":"j", "col":"ja", "type":"int"},
                        |"nation_region_fk":                {"cf":"j", "col":"jb", "type":"string"},
                        |"nation_geom":                     {"cf":"j", "col":"jc", "type":"string"},
