    ...
    def main(args: Array[String]) {
        ...
        def dateTableCatalog =
            s"""{
                ...
                |"columns":{
                    ...
                    |"city_fk":                {"cf":"h", "col":"ha", "type":"int"},
                    |"city_geom":              {"cf":"h", "col":"hb", "type":"string"},
                    |"nation_fk":              {"cf":"i", "col":"ia", "type":"int"},
                    |"nation_geom":            {"cf":"i", "col":"ib", "type":"string"},
                    |"region_fk":              {"cf":"j", "col":"ja", "type":"int"},
        ...
        var dateMakeGeomQuery = 
            ...
            |SELECT
                ...
                |city_fk,
                |ST_GeomFromWKT(city_geom) AS customer_city_geom,
                |nation_fk,
                |ST_GeomFromWKT(nation_geom) AS customer_nation_geom,
                |region_fk,
                |ST_GeomFromWKT(region_geom) AS customer_region_geom,
                |supplier_pk,
                |supplier_name,
                |supplier_address,
                |supplier_city,
