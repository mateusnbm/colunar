...
object M4BG1 {
    ...
    def main(args: Array[String]) {
        ...
        def customerTableCatalog =
            s"""{
                ...
                |"columns":{
                    ...
                    |"customer_city_fk":                {"cf":"c", "col":"cj", "type":"int"},
                    |"customer_nation_fk":              {"cf":"c", "col":"ck", "type":"int"},
                    |"customer_region_fk":              {"cf":"c", "col":"cl", "type":"int"}
                    |
                |}
            |}""".stripMargin
        ...
        def supplierTableCatalog =
            s"""{
                ...
                |"columns":{
                    ...
                    |"supplier_city_fk":                {"cf":"d", "col":"di", "type":"int"},
                    |"supplier_nation_fk":              {"cf":"d", "col":"dj", "type":"int"},
                    |"supplier_region_fk":              {"cf":"d", "col":"dk", "type":"int"}
                    |
                |}
            |}""".stripMargin
        ...
        customer_addrTableDataFrame.show()
        ...
        customer_addrSpatialTableDataFrame.printSchema()
        customer_addrSpatialTableDataFrame.show()
        ...
        supplier_addrTableDataFrame.show()
        ...
        supplier_addrSpatialTableDataFrame.printSchema()
        supplier_addrSpatialTableDataFrame.show()
        ...
        citySpatialTableDataFrame.printSchema()
        citySpatialTableDataFrame.show()
        ...
        nationSpatialTableDataFrame.printSchema()
        nationSpatialTableDataFrame.show()
        ...
        regionSpatialTableDataFrame.printSchema()
        regionSpatialTableDataFrame.show()
        ...
        var Q4 = 
            ...
            |   f.customer_addr_fk = c.customer_address_fk AND
            |   c.customer_pk = a.line_order_customer_fk AND
            |   a.line_order_part_fk = e.part_part_pk
            |
            | GROUP BY
